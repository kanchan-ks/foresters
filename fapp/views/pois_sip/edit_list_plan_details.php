            ...
            <?php //if(isset($plan_details['terms_in_years']) && $plan_details['terms_in_years']!=""){?>
                <div class="row form-row mb-3">
                    	<div class="col-md-3 text-right font-weight-bold"><label>Term in years</label></div>
                        	<div class="col-md-2">
                            			<select name="terms_in_years" id="terms_in_years" class="form-control terms_in_years matuarity_plan" placeholder="Years">
                    ...
                    <div class="row form-row mb-2">
                        ...
                        <div class="col-md-2  mb-2">
                            <?=form_dropdown('specific_matuarity_month',$list_maturity_month,@$plan_details['specific_matuarity_month'],'class="form-control select2 specific_matuarity_month" placeholder="Month" id="specific_matuarity_month"')?>
                        </div>
                        <div class="col-md-1  mb-2">
