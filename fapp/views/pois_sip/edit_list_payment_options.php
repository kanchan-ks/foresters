...
<form name="frmupdate_paymentoption" id="frmupdate_paymentoption" action="" method="post">
        <input type="hidden" name="data_type" value="payment_options">
        	...
        	<div class="col-md-12">
            	 <hr>
				<h4>Please complete the monthly Direct Debit section below.<input type="hidden" id="monthly_payment" class="badgebox pois_sip_pay_option" name="choose_payment_option_monthly" value="1"></h4>
