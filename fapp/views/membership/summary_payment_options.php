...
?>
			 <?php if(isset($payment_options['choose_payment_option_annual']) && $payment_options['choose_payment_option_annual'] == 1){?>
            <div class="row bg-light">
                <div class="col-md-3"><label>Membership fee</label></div>
                <div class="col-md-9 font-weight-bold"><label>&pound;<?=$payment_options['annual_innvest_amount']?></label></div>
                <div class="col-md-3"><label>Account holder name</label></div>
                <div class="col-md-9 font-weight-bold"><label><?=$payment_options['annual_account_holder_name']?></label></div>
                <div class="col-md-3"><label>Account number</label></div>
                <div class="col-md-9 font-weight-bold"><label><?=$payment_options['annual_account_number']?></label></div>
                <div class="col-md-3"><label>Sort Code</label></div>
                <div class="col-md-9 font-weight-bold"><label><?=$payment_options['annual_account_sort_code']?></label></div>
