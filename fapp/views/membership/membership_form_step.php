    ...
    <div class="page">
                ...
                <div class="row form-row mb-2" id="user_dob">
                   ...
                   <!-- </div>
                    ...
                    <div class="col-lg-1  mb-2">-->
                        ...
                        <?php 
						$back_year = date('Y', strtotime("0 years"));
						$last_year = date('Y', strtotime("-101 years"));
                ...
                <div class="row form-row mb-3">
                 ...
                 <div class="row form-row mb-3">
                  ...
                  <div class="form-group">
                        ...
                        <hr>
                         <div class="row form-row mb-3">
                            <div class="col-lg-4 text-right font-weight-bold">If relevant, please add the branch number you wish to be allocated to:</div>
                            <div class="col-lg-4">
                                <input type="text" name="branch_allocated" id="branch_allocated" value="" class="form-control"  autocomplete="OFF" maxlength="25">
                            </div>
                            <div class="col-lg-4"></div> 
                        </div>
                  </div>      
        ...
        <div class="row">
            ...
            <div class="row progressbar mt-2">
                <div class="col-md-12 bg-lightprogress">Membership fee</div>
            </div>
            <div class="row progressbar mt-2">
        ...
        <section id="membership_profile_section" class="membership_details hide">
        <form name="frmmembershipdetails" id="frmmembershipdetails" action="" method="post">
        ...
        <input type="hidden" name="step" value="2">
            ...
            <div class="row progressbar mb-2">
            	<div class="col-md-12 bg-limegreen">Membership fee</div>
            </div> 
     	   	<div class="row">
        	<div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <hr>
                    ...
                    <p class="head_title">Membership to Foresters Friendly Society costs &pound;<?=MEMBERSHIP_TERMS_FEE?> per year. Please tick the box below to confirm you wish to make this payment.</p>  
                    <div class="row form-row mb-5">
                    
                    	<div class="col-md-1 text-right font-weight-bold"></div>
                        	<div class="col-md-9">
                            
                               <label for="accept_membership_fee" class="btn-membership-fee font-weight-bold mt-1"><input type="checkbox" id="accept_membership_fee" name="accept_membership_fee" value="1" class="badgebox  required" required><span class="badge">&check;</span></label><p class="mt-2 pt-1">I confirm I wish to pay &pound;<?=MEMBERSHIP_TERMS_FEE?> per year.</p>
        ...
        <div class="row">
        	<div class="col-md-12">
            	<button type="submit" name="continue" class="btn pull-right" id="next_membership_details" data-step="2">Continue</button><button type="button" name="back" class="btn pull-left m-0 bg-light backbtn"  data-step="1">Back</button>
            </div>
        </div>
        ...
        <section id="payment_option_section" class="your_details hide">
            ...
            <?php //$this->view('membership/view_payment_options'); ?>
        </section>
            ...
            <div class="row">
                ...
                <hr>
                     <h4>Please check your details. If you need to make changes, click 'Edit'. When you have finished, click 'Submit Application' to complete your application.</h4>
                        ...
                        <!--<div class="mt-5 summarybox">
                            <h4 class="summary_heading pull-left">Membership fee</h4>
                           <a href="javascript:;" class="summary_edit btn btn-sm btn-warning edit_membership" data-type="membership_profile_section" data-step="2"><i class="fa fa-pencil"></i> Edit</a>
                            
                        </div>
                        <span class="edit_membership_section"></span>
                        <div class="col-md-12 summary_membership_section"></div>
                        -->
                        <div class="mt-5 summarybox">
                ...
                <input type="hidden" name="step" value="3">
              		<div class="mt-4 mb-3">
                    	...
                    	<div class="col-md-12 mb-3 no-padding">
                            	<h3>Discretionary Benefits</h3>
                               <p>As a Foresters Friendly Society member, you may be entitled to discretionary benefits, including financial grants, through your local Foresters Friendly Society branch. You will be allocated to your nearest branch automatically (unless you completed the Branch allocation section on this application form) and your local branch will contact you providing further details of the benefits available to you once your application is complete. Discretionary benefits are not regulated.</p>
                             
                        </div>

                        <div class="col-md-12 no-padding">
                            
                               <label for="summary_accept_terms" class="btn-summary-terms font-weight-bold mt-1"><input type="checkbox" id="summary_accept_terms" name="summary_accept_terms" value="1" class="badgebox  required" required><span class="badge">&check;</span></label><p class="pt-3">By submitting this application, I confirm I have read and understood the <a href="https://www.forestersfriendlysociety.co.uk/" target="_blank" class="view_declaration">declaration</a> and <a href="https://www.forestersfriendlysociety.co.uk/privacy-policy/" target="_blank" class="view_declaration">privacy policy</a> provided.</p>
...
<p>Once your payment is confirmed, your Tax Exempt Savings Plan application will be submitted to Foresters Friendly Society.</p>
        ...
        <section id="confirmation_section" class="your_details hide">
			...
			<hr>
				 <h4>Your Foresters Friendly Society Membership application has been submitted.</h4>
				
			   <div class="row form-row">
						<div class="col-md-12"><label>Your Direct Debit payment has now been set up.  The first payment will be collected on or around 1st <?=get_first_day_of_next_month()?>, and annually thereafter.</label></div>
				</div> 
					   <div class="row form-row">
						   <div class="col-md-12"><p><strong>Reference number: <span id="customer_ref_number">FFS1023702</span></strong><br>
				
				This reference number will be emailed to you but you can also print this page. Please quote this reference number whenever you talk to us about your Membership.<br><br>
				
				<strong>What happens next?</strong><br>
				
				You will receive your Membership pack in the post within 5 working days. Please keep it in a safe place.<br><br>
				...
				Thank you for choosing to become a Foresters member.</p>
        ...
        <div class="row">
        	<div class="col-md-12">
            	<a href="<?=base_url('membership/close_application')?>" class="btn pull-right closebtn">Close this window</a>
            </div>
        </div>
        </section>
