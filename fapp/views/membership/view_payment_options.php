...
?>
       ...
       <div class="row progressbar">
        ...
        <div class="row progressbar">
            ...
            <hr>
                 <h4>Please complete the Direct Debit section below. This is an annual Direct Debit.</h4>
                 
                <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><input type="hidden" id="annual_payment" class="badgebox membership_pay_option" name="choose_payment_option_annual" value="1"><input type="hidden" name="annual_innvest_amount" id="annual_innvest_amount" class="form-control required" placeholder="" required readonly="readonly" value="<?=TESP_MONTHLY_MIN_AMOUNT?>">
                    </div>
                </div>
                 <div class="annual_payment_box">
                    ...
                    <div class="row form-row mb-3">
                        ...
                        <div class="col-lg-5">
                            <div class="form-container active">
                                    <input placeholder="Account holder name" type="text" name="annual_account_holder_name" id="annual_account_holder_name"  class="form-control   requried" requried  autocomplete='OFF' value="<?=$payment_options['annual_account_holder_name']?>"  maxlength="50">
                            </div>
                        </div>
                    ...
                    <div class="row form-row mb-3">
                        ...
                        <div class="col-lg-5">
                            <div class="form-container active">
                                    ...
                                    <input placeholder="Account number" type="text" name="annual_account_number" id="annual_account_number" class="form-control mt-3 requried account_number" requried autocomplete='OFF' maxlength="8" value="<?=$payment_options['annual_account_number']?>">
                                    <input placeholder="Sort code" type="text" name="annual_account_sort_code" id="annual_account_sort_code"  class="form-control  mt-3 requried cvv_sort_code" requried  autocomplete='OFF'  maxlength="8" value="<?=$payment_options['annual_account_sort_code']?>">
                            </div>
                        </div>
                        <div class="col-lg-5"><!--<div class="card-wrapper"></div>--></div> 
                    </div>
                    ...
                    <div class="row form-row mt-2 mb-1">
                        ...
                        <div class="col-md-10"><label>Your first payment will be collected on or immediately after 1st <?=get_first_day_of_next_month()?>, and annually thereafter.</label></div>
                    </div>
                    ...
                    <div class="row form-row mb-1">
                    <div class="col-md-2"></div>
                        <div class="col-md-10"><label>By continuing, you confirm that you understand your annual Direct Debit will be taken from this account annually thereafter and will appear on bank statements as 'Ancient Order of Foresters Friendly Society Ltd'. Additionally, by continuing, you confirm this account is in the name provided, and the account holder is the only signatory required to authorise payments from this account.</label></div>
                    </div>
