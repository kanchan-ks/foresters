...
?>
        ...
        <div class="row progressbar">
         ...
         <div class="row progressbar">
            <div class="col-lg-12 bg-limegreen">Beneficiary</div>
        </div> 
        <div class="row progressbar mb-2">
            ...
            <hr>
                 ...
                 <input type="hidden" id="monthly_payment" class="badgebox over50_pay_option over50_monthly_payment" name="choose_payment_option_monthly" value="1" >
                 <div class="monthly_payment_box">
                     
                    <div class="row form-row mt-3 mb-3">
                        <div class="col-lg-2">&nbsp;</div>
                        <div class="col-lg-8"><label class="font-weight-bold">Please provide your bank account details:</label></div>
                        <div class="col-lg-2"></div> 
                    </div>
        ...
        <div class="row">
        	<div class="col-lg-12 pl-2">
                ...
                <button type="button" name="back" class="btn pull-left m-0 bg-light backbtn ml-2" data-step="4">Back</button>
            </div>
        </div>
