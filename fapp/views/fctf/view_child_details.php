...
<form name="frmupdate_childdetails" id="frmupdate_childdetails" action="" method="post">
        ...
        <input type="hidden" name="step" value="3">
            ...
            <hr>
                <div class="row form-row  mb-3">
                    ...
                    <div class="col-lg-4">
                    	<?=form_dropdown('title',array(""=>"Title","Mr"=>"Mr","Miss"=>"Miss"),$child_details['title'],'class="required select2 form-control" placeholder="Title"')?>
                ...
                <div class="form-group">
                    ...
                    <div class="row form-row mb-3">
                    	<div class="col-lg-4"></div><div class="col-lg-4">Please type the child's address or postcode and select from the list.</div><div class="col-lg-4"></div>
                        <div class="col-lg-4"></div><div class="col-lg-4"><a href="javascript:;" class="add_address_manually">Enter address manually</a></div><div class="col-lg-4"></div>
                    </div>
        ...
        <div class="row">
        	<div class="col-lg-12">
            	<button type="submit" name="continue" class="btn pull-right" id="next_child_details" data-step="3">Continue</button></button><button type="button" name="back" class="btn pull-left m-0 bg-light backbtn"  data-step="2">Back</button>
            </div>
        </div>
             </form>