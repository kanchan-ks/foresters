...
<div class="row bg-light">      
                                ...
                                <?=$old_address?>
                                <div class="col-md-3"><label>Relation to child</label></div>
                                <div class="col-md-9 font-weight-bold"><label><?=($personal_details['personal_details_relation_to_child'] == "Other")?$personal_details['personal_details_relation_other']:$personal_details['personal_details_relation_to_child'];?></label></div>
