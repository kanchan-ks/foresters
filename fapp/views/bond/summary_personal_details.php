...
?>
                <div class="row bg-light">      
                    ...
                    <div class="col-md-3"><label>Existing LISA Policy Number</label></div>
					...
					if(isset($payment_options)){
						...
						if(($payment_options['lumpsumEmployementStatus'] != "" || $payment_options['lumpsum_money_investment_source'] != "") && ($payment_options['lumpsum_innvest_amount'] >= 10000)){?>
