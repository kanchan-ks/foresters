                ...
                <div class="row form-row  mb-3">
                 ...
                 <div class="monthly_payment_box <?=($payment_options['choose_payment_option_monthly'] == 1)?"checked":"";?>">
                    ...
                    <div class="row form-row mt-3 mb-3">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-9"><p>The monthly contribution that you can pay into your Stocks & Shares ISA is from &pound;<?=SSISA_MONTHLY_MIN_AMOUNT?> up to &pound;<?=@number_format(SSISA_MONTHLY_MAX_AMOUNT,0,'',',');?> in the current tax year.</p><label class="font-weight-bold">Please provide your bank account details:</label></div>
                    ...
                    <div class="row form-row mb-1">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-11"><label>All information relating to your Direct Debit will be confirmed in writing within 5 working days of your application.</label></div>
                    </div>
                    <div class="row form-row mb-1">
                    <div class="col-lg-1"></div>
                        <div class="col-lg-11"><label>Please note that this Direct Debit, whilst being set up online, will still be covered by the standard Direct Debit safeguards and guarantees under the Direct Debit Scheme.</label></div>
                       
                    </div>
                    <div class="row form-row mb-2">
                    <div class="col-lg-1"></div>
                        <div class="col-lg-11"><label>By continuing, you confirm that you understand your monthly Direct Debit will be taken from this account on the 1st of each month and will appear on bank statements as 'Ancient Order of Foresters Friendly Society Ltd'.  Additionally, by continuing, you confirm this account is in your name, and you are the only signatory required to authorise payments from this account.</label></div>
                    </div>
                    ...
                    <div class="row form-row mb-1">
                    <div class="col-lg-1"></div>
                        <div class="col-lg-11"><p><strong>Anti-money laundering checks</strong> will take place if you invest a lump sum of &pound;10,000 or more, and as your contributions reach that amount, we need to ask you to complete two additional questions. If you have answered these in the monthly payment section above, then there is no need to complete them here too.</p>
...
.</p></div>
                     ...
                     <div class="col-lg-12">
                        <div class="row form-row  mb-3">
                        	<div class="col-lg-1"></div>
                            <div class="col-lg-2 text-right font-weight-bold"><label>The source of the money you are investing:</label></div>
                                <div class="col-lg-4">
            ...
            <hr>
                <div class="row form-row  mb-3">
                    <div class="col-lg-12 font-weight-bold"><label for="lumpsum_payment" class="btn-payment-option">Make a lump sum payment by debit card <input type="checkbox" id="lumpsum_payment" class="badgebox ssisa_pay_option" name="choose_payment_option_lumpsum" value="1" <?=($payment_options['choose_payment_option_lumpsum'] == 1)?"checked":"";?>><span class="badge">&plus;</span></label>
                    </div>
                </div>
                <div class="lumpsum_payment_box <?=($payment_options['choose_payment_option_lumpsum'] == 1)?"":"hide";?>">
                    <div class="row form-group">
                        ...
                        <div class="col-lg-1"></div>
                        <div class="col-lg-11 mt-3"><p>Because you are approaching the cut-off age for this product, you are eligible to make a payment from &pound;<?=$lumpsum_pay_amount_min?> rather than the usual &pound;<?=$lumpsum_pay_amount_max?>.</p></div>
                        <?php }?>
                        <?php if(get_session('set_topup') == true){?>
                         <div class="col-lg-1"></div>
                        <div class="col-lg-10 mt-3"><p>You can top up your ISA from &pound;<?=$lumpsum_pay_amount_min?> to &pound;<?=@number_format($lumpsum_pay_amount_max,0,'',',');?> in the current tax year.  Don't forget to deduct any payments already made this tax year.<br>Your lump sum payment will be taken at the end of your application.</p></div>
                        <?php }else{?>
                         <div class="col-lg-1"></div>
...
<p>We may verify your identity by carrying out an online check with a credit agency who will add a note to your reference file to show that an identity check has been made.  We may pass information to third parties for the prevention of crime or detection of fraud or where required by law.</p></div>
                     ...
                     <div class="col-lg-12">
                        <div class="row form-row  mb-3">
                        	<div class="col-lg-1"></div>
                            <div class="col-lg-2 font-weight-bold">The source of the money you are investing:</div>
                                <div class="col-lg-4">
            ...
            <hr>
                <div class="row form-row  mb-3">
                    <div class="col-lg-12 font-weight-bold"><label for="lumpsum_payment" class="btn-payment-option">Make a lump sum payment by debit card  <input type="checkbox" id="transfer_payment" class="badgebox ssisa_pay_option" name="choose_payment_option_transfer" value="1" <?=($payment_options['choose_payment_option_transfer'] == 1)?"checked":"";?>><span class="badge">&plus;</span></label>
