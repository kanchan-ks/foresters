...
?>
	<div class="container-fluid">
        <div class="row">
            <div class="col-md-12">            <div class="title-content">
    ...
    <div class="page">
            ...
            <input type="hidden" name="step" value="1">
             <input type="hidden" name="topup" value=" <?php if(get_session('set_topup') == true){ echo 1;}?>">
                ...
                <hr>
                    ...
                    <div class="row form-row mb-2" id="user_dob">
                        ...
                        <div class="col-lg-4  mb-2">
                            <select name="dob_day" id="dob_day" class="form-control dob_day select2" placeholder="Day">
                    ...
                    <div class="row form-row mb-3">
                     ...
                     <?php if(get_session('set_topup') == true){?>
                        <div class="form-group mb-5 mt-5">
                            ...
                            <hr>
                                <div class="row form-row  mb-3">
                                    <div class="col-lg-4 text-lg-right text-left font-weight-bold"><label>Existing Stock & Shares ISA policy number</label></div>
                                    <div class="col-lg-4">
...
<p>Once your payment is confirmed, your Stocks & Shares ISA application will be submitted to Foresters Friendly Society.</p>
        ...
        <section id="lumpsum_payment_section" class="your_details hide">
         <form name="frmlumpsum" id="frmlumpsum" action="" method="post">
          ...
          <input type="hidden" name="step" value="4">
            <div class="row progressbar">
                <div class="col-lg-12">
                <div class="bg-limegreen">Your Details</div>                
                </div>
            </div> 
            <div class="row progressbar">
                <div class="col-lg-12 bg-limegreen">Payment Options</div>
        ...
        <section id="confirmation_section" class="your_details hide">
         <div class="row progressbar">
            ...
            <hr>
                 <h4>Your Stocks & Shares ISA <span class="application_to_topup">application</span> has been submitted.</h4>
...
You will receive your Stocks & Shares ISA <span class="application_to_none"></span>pack in the post within 5 working days. Please keep it in a safe place.<br><br>
