...
<form name="frmupdate_yourdetails" id="frmupdate_yourdetails" action="" method="post">
        <input type="hidden" name="data_type" value="personal_details">
            ...
            <hr>
                ...
                <div class="row form-row mb-3">
                    <div class="col-lg-3 text-right font-weight-bold"><label>National Insurance number</label></div>
                ...
                <div class="row form-row mb-3">
                    <div class="col-lg-3 text-right font-weight-bold"><label>Phone</label></div>
                    <div class="col-lg-4">
                ...
                <div class="row form-row mb-3">
                    <div class="col-lg-3 text-right font-weight-bold"><label>Email</label></div>
                    <div class="col-lg-4">
                 ...
                 <div class="row form-row mb-3">
                    <div class="col-lg-3 text-right font-weight-bold"><label>Confirm email</label></div>
                    <div class="col-lg-4">
               ...
               <?php if(isset($personal_details['toptup_policy_number']) && $personal_details['toptup_policy_number'] != ""){?>
                    <div class="form-group mb-5 mt-5">
                        ...
                        <hr>
                            <div class="row form-row  mb-3">
                                <div class="col-lg-3 text-right font-weight-bold"><label>Existing Stocks & Shares ISA policy number</label></div>
                                <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <hr>
                     <div class="row form-row mb-3">
                        <div class="col-lg-3 text-right"><label class=" font-weight-bold">Postcode</label></div>
                        <div class="col-lg-2">
                    ...
                    <div class="row form-row mb-3">
                    	<div class="col-lg-3"></div><div class="col-lg-6">Please enter your postcode and click 'Find address'.</div><div class="col-lg-3"></div>
                        <div class="col-lg-3"></div><div class="col-lg-6"><a href="javascript:;" class="add_address_manually">Enter your address manually</a></div><div class="col-lg-3"></div>
                    </div>
                    ...
                    <div class="form-row mt-5">
                        <div class="col-lg-3 font-weight-bold">Have you changed address in the last 3 months?</div>
                            <div class="col-lg-4">
                                <div class="toggle">
                    ...
                    <div class="form-group old_address <?=($personal_details['old_address_change'] == "1")?"":"hide";?> mt-2">
                    	<!--<div class="row form-group mb-3">
                            <div class="col-lg-3"></div><div class="col-lg-6">Please enter your previous address here:</div><div class="col-lg-3"></div>
                        </div>-->
                        <div class="row form-row mb-3">
                            <div class="col-lg-3 text-right"><label class=" font-weight-bold">Postcode</label></div>
                            <div class="col-lg-2">
                        ...
                        <div class="row form-row mt-2 mb-3">
                            <div class="col-lg-3"></div><div class="col-lg-6">Please enter your postcode and click 'Find address'.</div><div class="col-lg-3"></div>
                            <div class="col-lg-3"></div><div class="col-lg-5"><a href="javascript:;" class="add_old_address_manually">Enter your address manually</a></div><div class="col-lg-4"></div>
                        </div>
                ...
                <div  class="form-group mt-5">
                    ...
                    <hr>
                     ...
                     <div class="row form-row  mb-3">
                    <div class="col-lg-3 text-right font-weight-bold"><label>How did you hear about us? (Optional)</label></div>
                    <div class="col-lg-4">
                ...
                <div class="row form-row  mb-3">
                    <div class="col-lg-3 text-right font-weight-bold"><label>Offer code (Optional)</label></div>
                    <div class="col-lg-4">
