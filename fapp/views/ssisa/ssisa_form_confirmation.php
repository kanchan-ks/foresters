    ...
    <div class="page">
        ...
        <section id="confirmation_section" class="your_details">
         <div class="row progressbar">
            ...
            <hr>
                 <h4>Your Stocks & Shares ISA <?php if(get_session('set_topup') == true){ echo "Top up";}else{ echo "application";}?> has been submitted.</h4>
...
You will receive your Stocks & Shares ISA <?php if(get_session('set_topup') == true){ echo "Top up ";}?>pack in the post within 5 working days. Please keep it in a safe place.<br><br>
