        ...
        <div class="row progressbar">
            ...
            <hr>
                ...
                <div class="row form-row  mb-3">
                    <div class="col-lg-12 font-weight-bold"><input type="hidden" id="monthly_payment" class="badgebox tesp_pay_option" name="choose_payment_option_monthly" value="1">
                    </div>
                </div>
                 <div class="monthly_payment_box">
                    ...
                    <div class="row form-row mt-3 mb-3">
                        ...
                        <div class="col-lg-9"><label class="font-weight-bold">Contributions are set at &pound;<?=TESP_MONTHLY_MIN_AMOUNT?> per month.<input type="hidden" name="monthly_innvest_amount" id="monthly_innvest_amount" class="form-control required" placeholder="" required readonly="readonly" value="<?=TESP_MONTHLY_MIN_AMOUNT?>"></label></div>
