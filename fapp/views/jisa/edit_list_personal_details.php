        ...
        <input type="hidden" name="data_type" value="personal_details">
            ...
            <hr>
                ...
                <div class="row form-row mb-2">
					...
					<input type="hidden" name="dob_day" value="<?=$personal_details['dob_day']?>">
                        <select name="dob_day_disabled" id="dob_day_disabled" class="form-control dob_day_disabled" disabled="disabled" placeholder="Day">
					...
					<input type="hidden" name="dob_month" value="<?=$personal_details['dob_month']?>">
						<?=form_dropdown('dob_month_disabled',$month,$personal_details['dob_month'],'class="form-control select2 dob_month_disabled" placeholder="Month"  disabled="disabled" id="dob_month_disabled"')?>
                    </div>
                    <div class="col-md-1  mb-2">
					<input type="hidden" name="dob_year" value="<?=$personal_details['dob_year']?>">
                        <select name="dob_year_disabled" id="dob_year_disabled" required class="form-control select2 required dob_year_disabled"  disabled="disabled" placeholder="Year">
               ...
               <?php if(isset($personal_details['toptup_policy_number']) && $personal_details['toptup_policy_number'] != ""){?>
                    <div class="form-group mb-5 mt-5">
                        ...
                        <hr>
                            <div class="row form-row  mb-3">
                                <div class="col-md-3 text-right font-weight-bold"><label>Existing Junior ISA policy number</label></div>
                                <div class="col-md-4">
