	...
	<div class="container-fluid">
        <div class="row">
            ...
            <div class="title-content">
                <h3>Child Tax Exempt Savings Plan</h3>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="page">
                ...
                <div  class="form-group mt-5">
                    ...
                    <hr>
                     <div class="col-lg-12 no-padding">
                        <p>Please tell us the relationship between you and the child for whom you are taking out this plan.</p>
        ...
        <div class="row">
            ...
            <div class="row progressbar mt-2">
                <div class="col-lg-12 bg-lightprogress">Child details</div>
            </div> 
        ...
        <input type="hidden" name="step" value="3">
            ...
            <div class="row progressbar">
                <div class="col-lg-12 bg-limegreen">Child Details</div>
            </div>
            <div class="row progressbar">
            ...
            <hr>
              <h4>Tell us how you want to set up your plan and click ‘Continue’.</h4>  
                
                <div class="form-group mt-3">
                	<h3>Monthly contributions</h3>
                   
                     <div class="row form-row mb-3">
                        <div class="col-lg-3 text-left"><label class=" font-weight-bold">Contributions are set at £25 per month</label></div>
                    </div>
                    <hr>
                   <h3>Savings term</h3>
                     ...
                     <div class="col-lg-1"></div>
                        <div class="col-lg-10"><p>This Child Tax Exempt Savings Plan can only mature after <span class="childs_name_on_maturity">kanchan</span>'s 16th birthday and must be a minimum of 10 years from today.</p>
        ...
        <?php //$this->view('ctesp/view_payment_options'); ?>
        </section>
...
<p>Once your payment is confirmed, your LISA application will be submitted to Foresters Friendly Society.</p>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><button type="submit" name="continue" class="btn pull-right" id="next5">Submit Application</button><button type="button" name="back" class="btn pull-left m-0 bg-light backbtn"  data-step="4">Back</button>
                </div>
            </div>
        ...
        <section id="confirmation_section" class="your_details hide">
            ...
            <hr>
                 <h4>Your Child Tax Exempt Savings Plan application has been submitted.</h4>
...
This reference number will be emailed to you but you can also print this page. Please quote this reference number whenever you talk to us about your Child Tax Exempt Savings Plan.<br><br>

<strong>What happens next?</strong><br>

You will receive your Child Tax Exempt Savings Plan pack in the post within 5 working days. Please keep it in a safe place.<br><br>
...
Thank you for choosing us as the provider of your Child Tax Exempt Savings Plan.</p>

<p class="font-weight-bold"><a href="https://www.forestersfriendlysociety.co.uk/foresters-customers/foresters-extras" target="_blank">Now you're a member, don't forget about your free member benefits.</a></p></div></div>
                        
                    </div>
            </div> 
        <div class="row">
        	<div class="col-lg-12">
            	<a href="<?=base_url('ctesp/close_application')?>" class="btn pull-right closebtn">Close this window</a>
            </div>
        </div>
        </section>
