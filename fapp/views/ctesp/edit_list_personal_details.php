        ...
        <input type="hidden" name="data_type" value="personal_details">
            ...
            <hr>
                <div class="row form-row  mb-3">
                    ...
                    <div class="col-md-4">
                    	<?=form_dropdown('title',$list_title,$personal_details['title'],'class="required form-control" placeholder="Title"')?>
                ...
                <div class="row form-row mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="first_name" id="first_name" value="<?=$personal_details['first_name']?>" class="form-control required" required autocomplete="OFF">
                    </div>
                    <div class="col-md-5"></div> 
                </div>
                ...
                <div class="row form-row mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="last_name" id="last_name" value="<?=$personal_details['last_name']?>" class="form-control required" required autocomplete="OFF">
                    </div>
                    <div class="col-md-5"></div> 
                </div>
               ...
               <?php if(isset($personal_details['toptup_policy_number']) && $personal_details['toptup_policy_number'] != ""){?>
                    <div class="form-group mb-5 mt-5">
                        ...
                        <hr>
                            <div class="row form-row  mb-3">
                                <div class="col-md-3 text-right font-weight-bold"><label>Existing LISA policy number</label></div>
                                <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group old_address <?=($personal_details['old_address_change'] == "1")?"":"hide";?> mt-2">
                        ...
                        <div class="row form-row mt-2 mb-3">
                            <div class="col-md-3"></div><div class="col-md-6">Please type your previous address or postcode and select from the list.</div><div class="col-md-3"></div>
                ...
                <div  class="form-group mt-5">
                    ...
                    <hr>
                     <div class="col-md-12 no-padding">
                        <p>Tell us the relationship between you and the child for whom you are taking out this plan.</p>
                        <div class="row form-row  mb-2">
                    		<div class="col-md-3 text-right font-weight-bold"></div>
                    			<div class="col-md-2">
                       				 <label for="personal_details_relation_Parent_Guardian_edit" class="btn-summary-terms font-weight-bold mt-1"><input type="radio" id="personal_details_relation_Parent_Guardian_edit" name="personal_details_relation_to_child" value="Parent/Guardian" class="badgebox  required personal_details_relation_to_child" required <?=($personal_details['personal_details_relation_to_child'] == "Parent/Guardian")?"checked":"";?> ><span class="badge">&check;</span></label><p class="mt-2">Parent/Guardian</p>
                                </div> 
                                <div class="col-md-2">
                       				 <label for="personal_details_relation_Grandparent_edit" class="btn-summary-terms font-weight-bold mt-1"><input type="radio" id="personal_details_relation_Grandparent_edit" name="personal_details_relation_to_child" value="Grandparent" <?=($personal_details['personal_details_relation_to_child'] == "Grandparent")?"checked":"";?> class="badgebox  required personal_details_relation_to_child" required><span class="badge">&check;</span></label><p class="mt-2">Grandparent</p>
                                </div> 
                                <div class="col-md-2">
                       				 <label for="personal_details_relation_Aunt_Uncle_edit" class="btn-summary-terms font-weight-bold mt-1"><input type="radio" id="personal_details_relation_Aunt_Uncle_edit" name="personal_details_relation_to_child" value="Aunt/Uncle" <?=($personal_details['personal_details_relation_to_child'] == "Aunt/Uncle")?"checked":"";?>  class="badgebox  required personal_details_relation_to_child" required><span class="badge">&check;</span></label><p class="mt-2">Aunt/Uncle</p>
                                </div> 
                                <div class="col-md-2">
                       				 <label for="personal_details_relation_Godparent_edit" class="btn-summary-terms font-weight-bold mt-1"><input type="radio" id="personal_details_relation_Godparent_edit" name="personal_details_relation_to_child" value="Godparent" <?=($personal_details['personal_details_relation_to_child'] == "Godparent")?"checked":"";?>  class="badgebox  required personal_details_relation_to_child" required><span class="badge">&check;</span></label><p class="mt-2">Godparent</p>
                                </div> 
                       ...
                       <div class="row form-row  mb-3">
                    		<div class="col-md-3 text-right font-weight-bold"></div>
                                ...
                                <div class="col-md-2">
                       				 <label for="personal_details_relation_Family_friend_edit" class="btn-summary-terms font-weight-bold mt-1"><input type="radio" id="personal_details_relation_Family_friend_edit" name="personal_details_relation_to_child" value="Family friend" <?=($personal_details['personal_details_relation_to_child'] == "Family friend")?"checked":"";?> class="badgebox  required personal_details_relation_to_child" required><span class="badge">&check;</span></label><p class="mt-2">Family friend</p>
                                </div> 
                               
                      			 <div class="col-md-2">
                       				 <label for="personal_details_relation_Other_edit" class="btn-summary-terms font-weight-bold mt-1"><input type="radio" id="personal_details_relation_Other_edit" name="personal_details_relation_to_child" value="Other" <?=($personal_details['personal_details_relation_to_child'] == "Other")?"checked":"";?> class="personal_details_relation_to_child badgebox  required personal_details_relation_to_child" required><span class="badge">&check;</span></label><p class="mt-2">Other</p>
                                </div> 
                                <div class="col-md-3">
                       				 <input type="text" name="personal_details_relation_other" id="personal_details_relation_other" value="<?=$personal_details['personal_details_relation_other']?>" class="form-control personal_details_relation_other <?=($personal_details['personal_details_relation_to_child'] == "Other")?"":"hide";?>">
                                </div>
