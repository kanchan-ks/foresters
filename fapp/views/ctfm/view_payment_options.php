...
?>
        ...
        <div class="row progressbar mb-2">
            ...
            <hr>
                 <h4>How would you like to add money to your CTF Maturities online portal?</h4>
                 <h4 class="mt-4">Please select and complete one or more of the expanding sections below.</h4>
                <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><label for="monthly_payment" class="btn-payment-option">Set up a monthly payment by Direct Debit <input type="checkbox" id="monthly_payment" class="badgebox ctfm_pay_option" name="choose_payment_option_monthly" value="1"><span class="badge">&Check;</span></label>
                    </div>
                </div>
                ...
                <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><label for="lumpsum_payment" class="btn-payment-option">Make a lump sum payment by debit card <input type="checkbox" id="lumpsum_payment" class="badgebox ctfm_pay_option" name="choose_payment_option_lumpsum" value="1"><span class="badge">&Check;</span></label>
                    </div>
                </div>
                ...
                <div class="lumpsum_payment_box hide">
                    <div class="row form-group">
                        ...
                        <?php if(get_session('set_topup') == true){?>
                        <div class="col-md-1"></div>
                        <div class="col-md-11 mt-5"><p>You can top up your Lifetime ISA from &pound;<?=$lumpsum_pay_amount_min?> to &pound;<?=$lumpsum_pay_amount_max?> in the current tax year.  Don't forget to deduct any payments already made this tax year.</p></div>
                        <?php }else{?>
                        <div class="col-md-1"></div>
                ...
                <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><label for="transfer_payment" class="btn-payment-option">Make a transfer in from another ISA provider <input type="checkbox" id="transfer_payment" class="badgebox ctfm_pay_option" name="choose_payment_option_transfer" value="1"><span class="badge">&Check;</span></label>
                    </div>
                </div>
                ...
                <div class="transfer_payment_box hide">
                	<div class="row form-row mt-2 mb-2">
                     	<div class="col-md-1"></div>
                        <div class="col-md-6">
                               <label for="ISA_transfer_option" class="pay-transfer-option"><input type="checkbox" id="ISA_transfer_option" name="ISA_transfer_option" value="1" class="badgebox ISA_transfer_option "><span class="badge">&check;</span>Click this box if you want to transfer an existing ISA to a Foresters Lifetime ISA</label>
                    ...
                    <p><i class="fa fa-file-pdf-o" aria-hidden="true"></i> <a href="<?=base_url('ctfm/transfer_form')?>" class="font-weight-bold" target="_blank">Your CTF Maturities online portal Transfer form &raquo;</a></p></div>
                    </div>
                 </div>
