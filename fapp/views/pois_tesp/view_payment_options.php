                        ...
                        <div class="col-md-5">
                            <div class="input-group">
                              <div class="input-group-prepend">
                                <span class="input-group-text">Monthly payment   &pound;</span>
                              </div>
                              <input type="text"  class="form-control" placeholder="" required autocomplete="OFF" value="<?=POIS_TESP_MONTHLY_AMOUNT?>" maxlength="7" disabled="disabled">
