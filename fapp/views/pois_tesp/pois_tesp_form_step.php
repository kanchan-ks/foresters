...
?>
    ...
    <div class="page">
            ...
            <hr>
              <div class="form-group mt-4">
                    <div class="row form-row">
                        <div class="col-md-10"><p class="font-weight-bold">The amount you will save each month</p></div>
                    </div> 
                    
                    <div class="row form-row mb-5">
                        <div class="col-md-10"><p>Contribution are set as &pound;<?=POIS_TESP_MONTHLY_AMOUNT?> per month.</p></div>
                    </div> 
                    ...
                    <div class="row form-row mb-5">
                        <div class="col-md-10"><p>Contributions for this Tax Exempt Savings Plan will be collected for 10 years.</p></div>
                    </div>
                </div>
        ...
        <div class="row">
        	<div class="col-md-12">
            	<button type="submit" name="continue" class="btn pull-right" id="next_plan_details" data-step="2">Continue</button><button type="button" name="back" class="btn pull-left m-0 bg-light backbtn"  data-step="1">Back</button>
            </div>
        </div>
        ...
        <?php //$this->view('POIS_TESP/view_payment_options'); ?>
        </section>
        ...
        <div class="row progressbar mb-2">
            ...
            <div class="row mt-3">
                <div class="col-md-12"> <button type="submit" name="continue" class="btn pull-right" id="next5">Submit Application</button><button type="button" name="back" class="btn pull-left m-0 bg-light backbtn"  data-step="3">Back</button>
                </div>
            </div>
        ...
        <div class="row">
        	<div class="col-md-12">
            	<a href="<?=base_url('pois_tesp/close_application')?>" class="btn pull-right closebtn">Close this window</a>
            </div>
        </div>
        </section>
