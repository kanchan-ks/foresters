        ...
        <input type="hidden" name="step" value="1">
            ...
            <hr>
                ...
                <div class="row form-row mb-2">
                    ...
                    <div class="col-lg-4  mb-2" id="user_bob">
                ...
                <div class="row form-row mb-3">
                 ...
                 <?php if(get_session('set_topup') == true){?>
                    <div class="form-group mb-5 mt-5">
                        ...
                        <hr>
                            <div class="row form-row  mb-3">
                                <div class="col-lg-4 text-right font-weight-bold"><label>Existing Lifetime ISA policy number</label></div>
                                <div class="col-lg-4">
...
<p>Once your payment is confirmed, your Lifetime ISA application will be submitted to Foresters Friendly Society.</p>
            ...
            <div class="row mt-3">
                <div class="col-lg-12"><button type="submit" name="continue" class="btn pull-right" id="next5">Submit Application</button><button type="button" name="back" class="btn pull-left m-0 bg-light backbtn"  data-step="2">Back</button>
                </div>
            </div>
        ...
        <section id="confirmation_section" class="your_details hide">
         <div class="row progressbar">
            ...
            <hr>
                 <h4>Your Lifetime ISA <span class="application_to_topup">application</span> has been submitted.</h4>
...
You will receive your Lifetime ISA<span class="application_to_none"></span>pack in the post within 5 working days. Please keep it in a safe place.<br><br>
