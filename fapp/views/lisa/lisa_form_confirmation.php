    ...
    <div class="page">
        ...
        <section id="confirmation_section" class="your_details">
         <div class="row progressbar">
            ...
            <hr>
                 <h4>Your Lifetime ISA <?php if(get_session('set_topup') == true){ echo "Top up";}else{ echo "application";}?> has been submitted.</h4>
               ...
               <div class="row form-row">
                       ...
                       <div class="col-md-12"><p><strong>Reference number: <span id="customer_ref_number"><?=$cutomer_ref_number?></span></strong><br>
						<?php if(isset($payment_reference_number) && $payment_reference_number!=""){?><strong>Worldpay Transaction ID: <?=$payment_reference_number?></strong><br><?php }?>
...
You will receive your Lifetime ISA <?php if(get_session('set_topup') == true){ echo "Top up ";}?>pack in the post within 5 working days. Please keep it in a safe place.<br><br>
