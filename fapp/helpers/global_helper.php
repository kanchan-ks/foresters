...
function personal_details()
{
	...
	$personal_details['NI1']='';
	$personal_details['NI2']='';
	$personal_details['NI3']='';
	$personal_details['NI4']='';
	$personal_details['NI5']='';
...
function payment_options()
{
	...
	$payment_options['annual_innvest_amount'] = '';
	$payment_options['annual_account_holder_name'] = '';
	$payment_options['annual_account_number'] = '';
	$payment_options['annual_account_sort_code'] = '';
	$payment_options['choose_payment_option'] = '';
	...
	$payment_options['lumpsumEmployementStatus_joint'] = '';
	$payment_options['lumpsumEmployementStatus_extra_joint'] = '';
	$payment_options['lumpsum_money_investment_source_joint'] = '';
	$payment_options['lumpsum_money_investment_source_extra_joint'] = '';
	$payment_options['accept_account_holder_terms'] = '';
	$payment_options['third_party_title'] = '';
	$payment_options['third_party_other_title'] = '';
	$payment_options['third_party_first_name'] = '';
	$payment_options['third_party_last_name'] = '';
	$payment_options['third_party_phone'] = '';
	$payment_options['third_party_email'] = '';
	$payment_options['third_party_cemail'] = '';
...
function child_details()
{
	...
	$child_details['parent_same_address_child'] = 0;
...
function beneficiary_details()
{
	...
	$beneficiary_details['nominate_benificiary'] = '';
	$beneficiary_details['beneficiary_title'] = '';
	$beneficiary_details['beneficiary_other_title'] = '';
	$beneficiary_details['first_name'] = '';
	$beneficiary_details['last_name'] = '';
	$beneficiary_details['bdob_day'] = '';
	$beneficiary_details['bdob_month'] = '';
	$beneficiary_details['bdob_year'] = '';
	$beneficiary_details['address1'] = '';
	$beneficiary_details['address2'] = '';
	$beneficiary_details['town'] = '';
	$beneficiary_details['county'] = '';
	$beneficiary_details['postcode_box'] = '';
	$beneficiary_details['postcode'] = '';
	$beneficiary_details['beneficiary_amount'] = '';
...
function get_how_did_you_hear_aboutus($value)
{
	...
	if($value!="" && array_key_exists($value, $list_value))
...
function pois_list_how_did_you_hear_aboutus()
{
	return array(""=> "Please select", "PMAIL"=>"POIS Mailing", "PSEAR"=>"Search engine (e.g. Google)", "PEME"=>"I am an existing member", "PREF"=>"Referral from a POIS member", "PINT"=>"Referral from a POIS Introducer", "PCREF"=>"Referral from a Foresters branch", "PPRES"=>"Press article/advert", "PSOCM"=>"Social Media", "PWEBO"=>"Other Website", "POTHE"=>"Other");
}

function pois_get_how_did_you_hear_aboutus($value)
{
	$list_value = pois_list_how_did_you_hear_aboutus();
...
function jisa_steps_pregressbar($step=1)
{
	...
	if($step == 1){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="child_details"><a href="#child_details" data-toggle="tab" aria-expanded="false" >Child\'s details</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment options</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish "><a href="#finish" data-toggle="tab" aria-expanded="true">Confirmation</a></li>';
	}elseif($step == 2){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="child_details active"><a href="#child_details" data-toggle="tab" aria-expanded="false" >Child\'s details</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment options</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish "><a href="#finish" data-toggle="tab" aria-expanded="true">Confirmation</a></li>';
	}elseif($step == 3){
	...
	return stripslashes($steps_html);
}
...
function ctfm_steps_pregressbar($step=1)
{
	...
	if($step == 1){
		$steps_html .= '<li class="your_details active"><a href="#your_choice" data-toggle="tab" aria-expanded="false" >Unique ID</a></li>
						...
						<li class="your_choice"><a href="#your_choice" data-toggle="tab" aria-expanded="false" >Your choice</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
		...
		$steps_html .= '<li class="your_details active"><a href="#your_choice" data-toggle="tab" aria-expanded="false" >Unique ID</a></li>
        				<li class="child_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="your_choice active"><a href="#your_choice" data-toggle="tab" aria-expanded="false" >Your choice</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="your_identity"><a href="#your_identity" data-toggle="tab" aria-expanded="false">Your identity</a></li>
						<li class="summary"><a href="#declaration" data-toggle="tab" aria-expanded="false">Declaration</a></li>';
	}elseif($step == 4){
...
function bond_steps_pregressbar($step=1)
{
	...
	if($step == 1){
		$steps_html .= '<li class="policy_type active"><a href="#policy_type" data-toggle="tab" aria-expanded="false" >Policy type</a></li>
						...
						<li class="applicant_details"><a href="#applicant_details" data-toggle="tab" aria-expanded="false">Second applicant</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
		...
		$steps_html .= '<li class="policy_type active"><a href="#policy_type" data-toggle="tab" aria-expanded="false" >Policy type</a></li>
						<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="applicant_details active"><a href="#applicant_details" data-toggle="tab" aria-expanded="false" >Second applicant</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="confirmation"><a href="#confirmation" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
	}elseif($step == 4){
...
function fctf_steps_pregressbar($step=1)
{
	$steps_html = '<ul class="nav nav-tabs wizard" id="progressbar">';
	if($step == 1){
		$steps_html .= '<li class="policy_type active"><a href="#policy_type" data-toggle="tab" aria-expanded="false" >Policy number</a></li>
						<li class="your_details"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="applicant_details"><a href="#applicant_details" data-toggle="tab" aria-expanded="false" >Child\'s details</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="confirmation"><a href="#confirmation" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
	}elseif($step == 2){
		...
		$steps_html .= '<li class="policy_type active"><a href="#policy_type" data-toggle="tab" aria-expanded="false" >Policy number</a></li>
						<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="applicant_details active"><a href="#applicant_details" data-toggle="tab" aria-expanded="false" >Child\'s details</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="confirmation"><a href="#confirmation" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
	}elseif($step == 4){
		$steps_html .= '<li class="policy_type active"><a href="#policy_type" data-toggle="tab" aria-expanded="false" >Policy number</a></li>
						<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="applicant_details active"><a href="#applicant_details" data-toggle="tab" aria-expanded="false" >Child\'s detailst</a></li>
						<li class="payment_option active"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="confirmation"><a href="#confirmation" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
	}elseif($step == 5){
...
function over50_steps_pregressbar($step=1)
{
	$steps_html = '<ul class="nav nav-tabs wizard" id="progressbar">';
	if($step == 1){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="premiums_details"><a href="#premiums_details" data-toggle="tab" aria-expanded="false" >Premiums</a></li>
						<li class="beneficiary_details"><a href="#beneficiary_details" data-toggle="tab" aria-expanded="false" >Beneficiary</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish "><a href="#finish" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
	}elseif($step == 2){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="premiums_details active"><a href="#premiums_details" data-toggle="tab" aria-expanded="false" >Premiums</a></li>
						<li class="beneficiary_details"><a href="#beneficiary_details" data-toggle="tab" aria-expanded="false" >Beneficiary</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish "><a href="#finish" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
		...
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="premiums_details active"><a href="#premiums_details" data-toggle="tab" aria-expanded="false" >Premiums</a></li>
						<li class="beneficiary_details active"><a href="#beneficiary_details" data-toggle="tab" aria-expanded="false" >Beneficiary</a></li>
						<li class="payment_option "><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish "><a href="#finish" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
	}elseif($step == 4){
		...
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						...
						<li class="payment_option active"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary active"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish active"><a href="#finish" data-toggle="tab" aria-expanded="false">Confirmation</a></li>';
	}
	$steps_html .= '</ul>';
...
function membership_steps_pregressbar($step=1)
{
	$steps_html = '<ul class="nav nav-tabs wizard" id="progressbar">';
	if($step == 1){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="membership_fee"><a href="#membership_fee" data-toggle="tab" aria-expanded="false" >Membership fee</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish "><a href="#finish" data-toggle="tab" aria-expanded="true">Confirmation</a></li>';
	}elseif($step == 2){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="membership_fee active"><a href="#membership_fee" data-toggle="tab" aria-expanded="false" >Membership fee</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>
						<li class="finish "><a href="#finish" data-toggle="tab" aria-expanded="true">Confirmation</a></li>';
	}elseif($step == 3){
...
//POIS
function pois_sip_steps_pregressbar($step=1)
{
	$steps_html = '<ul class="nav nav-tabs wizard" id="progressbar">';
	if($step == 1){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="health_declaration"><a href="#health_declaration" data-toggle="tab" aria-expanded="false" >Health declaration</a></li>
						<li class="plan_deatils"><a href="#plan_deatils" data-toggle="tab" aria-expanded="false" >Plan details</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>';
	}elseif($step == 2){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="health_declaration active"><a href="#health_declaration" data-toggle="tab" aria-expanded="false" >Health declaration</a></li>
						<li class="plan_deatils"><a href="#plan_deatils" data-toggle="tab" aria-expanded="false" >Plan details</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>';
	}elseif($step == 3){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
						<li class="health_declaration active"><a href="#health_declaration" data-toggle="tab" aria-expanded="false" >Health declaration</a></li>
						<li class="plan_deatils active"><a href="#plan_deatils" data-toggle="tab" aria-expanded="false" >Plan details</a></li>
						<li class="payment_option"><a href="#payment_option" data-toggle="tab" aria-expanded="false">Payment details</a></li>
						<li class="summary"><a href="#summary" data-toggle="tab" aria-expanded="false">Summary</a></li>';
	}elseif($step == 4){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
...
function pois_tesp_steps_pregressbar($step=1)
{
	$steps_html = '<ul class="nav nav-tabs wizard" id="progressbar">';
	if($step == 1){
		$steps_html .= '<li class="your_details active"><a href="#your_details" data-toggle="tab" aria-expanded="false" >Your details</a></li>
...
function generate_app_unique_id($prefx)
{
	$unique_id = $prefx . date("ymdhis") . rand(1000,9999);
...
function get_first_day_of_next_month(){
	$today = date('d');
	if($today < 14)
		return date("F Y", strtotime("+30 days"));
	else
		return 	date("F Y", strtotime("+48 days"));
