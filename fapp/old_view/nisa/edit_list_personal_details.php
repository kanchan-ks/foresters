            ...
            <hr>
                ...
                <div class="row form-row mb-2">
                    ...
                    <div class="col-md-2  mb-2">
						<?=form_dropdown('dob_month',$month,$personal_details['dob_month'],'class="form-control select2 birth_day" placeholder="Month" id="dob_month"')?>
                    </div>
                    <div class="col-md-1  mb-2">
                ...
                <div class="row form-row mb-3">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="phone" id="phone"  value="<?=$personal_details['phone']?>" class="form-control required" required  autocomplete="OFF">
                    </div>
                    <div class="col-md-5"></div> 
                </div>
                <div class="row form-row mb-3">
                ...
                <div class="form-group">
                    ...
                    <hr>
                     <div class="row form-row mb-3">
                        ...
                        <div class="col-md-2">
                            <input type="text" name="postcode" id="postcode"  value="<?=$personal_details['postcode']?>" class="form-control required postcode" required placeholder="Eg SO15 3EW">
                            </div>
                    ...
                    <div class="form-group old_address <?=($personal_details['old_address_change'] == "1")?"":"hide";?> mt-2">
                        ...
                        <div class="row form-row mb-3">
                            <div class="col-md-3 text-right"><label class=" font-weight-bold">Postcode</label></div>
                            <div class="col-md-2">
                                <input type="text" name="postcode_additional" id="postcode_additional" value="<?=$personal_details['postcode_additional']?>" class="form-control" required placeholder="Eg SO15 3EW">
                                </div>
                            <div class="col-md-2  text-right  no-padding">
                                <button type="button" class="btn btn-success btn-sm find_address">Find address</button>
                            </div>
                ...
                <div class="row form-row  mb-3">
                    ...
                    <div class="col-md-4">
                       <input type="text" name="toptup_policy_number" id="toptup_policy_number" value="<?=$personal_details['toptup_policy_number']?>" class="form-control" maxlength="4"></div>
                    <div class="col-md-5"></div> 
                </div>
                <?php }?>
                 </div>  
