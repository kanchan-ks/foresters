...
<div class="row bg-light">      
                                ...
                                <div class="col-md-9 font-weight-bold"><label><?=$personal_details['dob_day']?>-<?=date("M", $personal_details['dob_month'])?>-<?=$personal_details['dob_year']?></label></div>
                                <div class="col-md-3"><label>National Insurance number</label></div>
                                <div class="col-md-9 font-weight-bold"><label><?=$personal_details['NI1']?>-<?=$personal_details['NI2']?>-<?=$personal_details['NI3']?>-<?=$personal_details['NI4']?>-<?=$personal_details['NI5']?></label></div>
