                ...
                <div class="row form-row  mb-3">
                 ...
                 <div class="monthly_payment_box <?=($payment_options['choose_payment_option_monthly'] == 1)?"":"hide";?>">
                    ...
                    <div class="row form-row mt-3 mb-3">
                        <div class="col-md-1">&nbsp;</div>
                        <div class="col-md-9"><p>The monthly contribution that you can pay into your Stocks & Shares ISA is from &pound;<?=SSISA_MONTHLY_MIN_AMOUNT?> up to &pound;<?=@number_format(SSISA_MONTHLY_MAX_AMOUNT,0,'',',');?> in the current tax year.</p> 
						<?php if(get_session('set_topup') == true){?>
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-md-5 font-weight-bold">
                            <div class="form-container active">
                                    <input placeholder="Account holder name" type="text" name="monthly_account_holder_name" id="monthly_account_holder_name"  class="form-control  mb-3  requried" requried  autocomplete='OFF' maxlength="50" value="<?=$payment_options['monthly_account_holder_name']?>">
                    ...
                    <div class="row form-row mb-1 hide show_monthly_high_value_text">
                    <div class="row form-row mb-1">
                    <div class="col-md-1"></div>
                        <div class="col-md-10"><p><strong>Money laundering checks</strong> will take place if you invest a lump sum of &pound;10,000 or more, and as you your contributions reach that amount, we need to ask you to complete two additional questions.</p>
...
.</p></div>
                     ...
                     <div class="col-md-12">
                        <div class="row form-row  mb-3">
                            ...
                            <div class="col-md-2 font-weight-bold"><label>Employment status:</label></div>
                                <div class="col-md-4">
                                    <?=form_dropdown('EmployementStatus',$employement_status,'','class="form-control EmployementStatus required" placeholder="Please Select" id="EmployementStatus" required')?>
                                    
                                    <input type="text" name="EmployementStatus_extra" id="EmployementStatus_extra" value="" class="form-control hide mt-2 EmployementStatus_extra required" placeholder='Please enter other employement status' required autocomplete="off" <?=($payment_options['choose_payment_option_monthly'] == 1)?"":"hide";?>>
                                </div>
                     ...
                     <div class="col-md-12">
                        <div class="row form-row  mb-3">
                        	<div class="col-md-1"></div>
                            <div class="col-md-2 font-weight-bold"><label>The source of the money you are investing:</label></div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="money_investment_source_extra" id="money_investment_source_extra" value="" class="form-control <?=($payment_options['money_investment_source'] == "Other")?"":"hide";?> mt-2 money_investment_source_extra required" placeholder='Please enter other source' required autocomplete="off" <?=$payment_options['money_investment_source_extra'];?>>
                                </div>
                            	<div class="col-md-5"></div> 
                        </div>
                     </div>
                ...
                <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><label for="lumpsum_payment" class="btn-payment-option">Make a lump sum payment by debit card <input type="checkbox" id="lumpsum_payment" class="badgebox ssisa_pay_option ssisa_lumpsum_payment" name="choose_payment_option_lumpsum" value="1" <?=($payment_options['choose_payment_option_lumpsum'] == 1)?"checked":"";?>><span class="badge">&check;</span></label>
                    </div>
                </div>
                ...
                <div class="lumpsum_payment_box <?=($payment_options['choose_payment_option_lumpsum'] == 1)?"":"hide";?>">
                    <div class="row form-group">
                        ...
                        <div class="col-md-1"></div>
                        <div class="col-md-10 mt-3"><p>Because you are approaching the cut-off age for this product, you are eligible to make a payment from &pound;<?=$lumpsum_pay_amount_min?> rather than the usual &pound;<?=@number_format($lumpsum_pay_amount_max,0,'',',');?>.</p></div>
                        <?php }?>
                        <?php if(get_session('set_topup') == true){?>
                         <div class="col-md-1"></div>
...
<p>We may verify your identity by carrying out an online check with a credit agency who will add a note to your reference file to show that an identity check has been made.  We may pass information to third parties for the prevention of crime or detection of fraud or where required by law.</p></div>
                        ...
                        <div class="row form-row  mb-3">
                            ...
                            <div class="col-md-2 font-weight-bold"><label>Employment status:</label></div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="lumpsumEmployementStatus_extra" id="lumpsumEmployementStatus_extra" value="<?=$payment_options['lumpsumEmployementStatus_extra'];?>" class="form-control hide mt-2 lumpsumEmployementStatus_extra required" placeholder='Please enter other employement status' required autocomplete="off">
                                </div>
                            	<div class="col-md-5"></div> 
                        </div>
                     </div>  
                        ...
                        <div class="row form-row  mb-3">
                            ...
                            <div class="col-md-2 font-weight-bold">The source of the money you are investing:</div>
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="lumpsum_money_investment_source_extra" id="lumpsum_money_investment_source_extra" value="<?=$payment_options['lumpsum_money_investment_source_extra'];?>" class="form-control hide mt-2 lumpsum_money_investment_source_extra required" placeholder='Please enter other source' required autocomplete="off">
                                </div>
                            	<div class="col-md-5"></div> 
                        </div>
                     </div>
                ...
                <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><label for="transfer_payment" class="btn-payment-option">Make a transfer in from another ISA provider <input type="checkbox" id="transfer_payment" class="badgebox ssisa_pay_option ssisa_transfer_payment" name="choose_payment_option_transfer" value="1" <?=($payment_options['choose_payment_option_transfer'] == 1)?"checked":"";?>><span class="badge">&check;</span></label>
                    </div>
                </div>
                ...
                <div class="transfer_payment_box <?=($payment_options['choose_payment_option_transfer'] == 1)?"":"hide";?>">
                    ...
                    <p><i class="fa fa-file-pdf-o" aria-hidden="true"></i> <a href="<?=base_url('ssisa/transfer_form')?>" target="_blank">Your Stocks & Shares ISA Transfer form &raquo;</a></p></div>
                    </div>
                 </div>
