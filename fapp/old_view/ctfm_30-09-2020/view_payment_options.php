...
?>
        ...
        <div class="row progressbar mb-2">
            ...
            <hr>
                 ...
                 <h4 class="mt-3">Don't forget to factor in any payments already made this tax year when working out how much you can top-up your CTF Maturities online portal by.</h4>
                 <?php }?>
                ...
                <div class="lumpsum_payment_box hide">
                    <div class="row form-group">
                        ...
                        <?php if(get_session('set_topup') == true){?>
                        <div class="col-md-1"></div>
                        <div class="col-md-11 mt-5"><p>You can top-up your LISA from &pound;<?=$lumpsum_pay_amount_min?> to &pound;<?=$lumpsum_pay_amount_max?> in the current tax year.  Don't forget to deduct any payments already made this tax year.</p></div>
                        <?php }else{?>
                        <div class="col-md-1"></div>
                ...
                <div class="transfer_payment_box hide">
                	<div class="row form-row mt-2 mb-2">
                     	<div class="col-md-1"></div>
                        <div class="col-md-6">
                               <label for="ISA_transfer_option" class="pay-transfer-option"><input type="checkbox" id="ISA_transfer_option" name="ISA_transfer_option" value="1" class="badgebox ISA_transfer_option "><span class="badge">&check;</span>Click this box if you want to transfer an existing ISA to a Foresters LISA</label>
                    ...
                    <p><i class="fa fa-file-pdf-o" aria-hidden="true"></i> <a href="<?=base_url('ctfm/transfer_form')?>" target="_blank">Your CTF Maturities online portal Transfer form &raquo;</a></p></div>
                    </div>
                 </div>
