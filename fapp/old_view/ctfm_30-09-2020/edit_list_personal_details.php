...
?>
<form name="frmupdate_personaldetails" id="frmupdate_personaldetails" action="" method="post">
		...
		<input type="hidden" name="uid" value="<?=ed('e', @$personal_details->id);?>">
            ...
            <hr>
			<h4 class="mb-3 mt-3">Please check your details below. If anything is incorrect, please call us on the number above.</h4>
                ...
                <div class="row form-row mb-3">
                    <div class="col-md-3 text-right font-weight-bold"><label>Child Trust Fund Unique Reference Number</label></div>
                    <div class="col-md-4">
				 ...
				 <div class="form-group">
					...
					<div class="row form-row mb-3">
						...
						<div class="col-md-4"><input type="text" name="NI1" id="NI1" maxlength="2" class="form-control ni-segment"  autocomplete="OFF" value="<?=@$ni_number['0']?>"> <input type="text" name="NI2" id="NI2" maxlength="2" class="form-control ni-segment" autocomplete="OFF" value="<?=@$ni_number['1']?>"> <input type="text" name="NI3" id="NI3" maxlength="2" class="form-control ni-segment" autocomplete="OFF" value="<?=@$ni_number['2']?>"> <input type="text" name="NI4" id="NI4" maxlength="2" class="form-control ni-segment" autocomplete="OFF" value="<?=@$ni_number['3']?>"> <input type="text" name="NI5" id="NI5" maxlength="1" class="form-control ni-segment ni-segment-last" autocomplete="OFF" value="<?=@$ni_number['4']?>"></div>
						<div class="col-md-5"></div> 
					</div>
					<div class="row form-row mb-3">
					...
					<div class="row form-row mb-3">
						...
						<div class="col-md-4">
							<input type="email" name="cemail" id="cemail"  value="<?=@$personal_details->email?>" class="form-control required" required autocomplete="OFF">
						</div>
						<div class="col-md-5"></div> 
					</div>
				...
				<div class="form-group mb-5 mt-5">
					...
					<hr>
						<div class="row form-row  mb-3">
							<div class="col-md-3 text-right font-weight-bold"><label>Foresters Friendly Society Child Trust Fund policy number </label></div>
							<div class="col-md-4">
        ...
        <div class="row">
        	<div class="col-md-12">
            	<button type="submit" name="continue" class="btn pull-right" id="update_personal_details" data-step="3">Update</button>
            </div>
        </div>
             </form>