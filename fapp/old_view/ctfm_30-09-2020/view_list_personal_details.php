...
<form name="frmupdate_yourdetails" id="frmupdate_yourdetails" action="" method="post">
		...
		<input type="hidden" name="uid" value="<?=ed('e', @$personal_details->id);?>">
            ...
            <hr>
			<h4 class="mb-3 mt-3">We have pre-filled some of this information to make the form easier for you. If any information is incorrect, please call us on 0800 988 2418.</h4>
