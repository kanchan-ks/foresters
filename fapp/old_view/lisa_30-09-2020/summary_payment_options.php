...
?>
            ...
            <div class="row bg-light">
                ...
                <div class="col-md-9 font-weight-bold"><label>&pound;<?=@number_format(str_replace(",","",$payment_options['monthly_innvest_amount']),'2','.',',')?></label></div>
            ...
            <div class="row bg-light">      
                ...
                <div class="col-md-9 font-weight-bold"><label>&pound;<?=@number_format(str_replace(",","",$payment_options['lumpsum_innvest_amount']),'2','.',',')?></label></div>
            </div> 
            <?php }?>
