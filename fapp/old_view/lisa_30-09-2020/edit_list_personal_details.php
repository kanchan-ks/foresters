                ...
                <div class="form-group">
                    ...
                    <hr>
                     <div class="row form-row mb-3">
                        ...
                        <div class="col-md-2 afd-typeahead-container">
                            <input type="text" name="postcode" id="postcode"  value="<?=$personal_details['postcode']?>" class="form-control postcode" placeholder="Eg SO15 3EW"autocomplete="off" data-afd-control="typeahead">
                            </div>
                    ...
                    <div class="form-group extra_add <?=($personal_details['address1'] != "")?"":"hide";?>  mt-5">
                        <div class="row form-row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="address1" id="address1" value="<?=$personal_details['address1']?>" class="form-control" required data-afd-result="Street"></div>
                            <div class="col-md-5"></div> 
                        </div>
                	</div>
                    <div class="form-group extra_add <?=($personal_details['address1'] != "")?"":"hide";?>">
                        <div class="row form-row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="address2" id="address2" value="<?=$personal_details['address2']?>" class="form-control" data-afd-result="Locality"></div>
                            <div class="col-md-5"></div> 
                        </div>
                	</div>
                    <div class="form-group extra_add <?=($personal_details['address1'] != "")?"":"hide";?>">
                        <div class="row form-row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="town" id="town" value="<?=$personal_details['town']?>" class="form-control" required data-afd-result="Town"></div>
                            <div class="col-md-5"></div> 
                        </div>
                	</div>
                    <div class="form-group extra_add <?=($personal_details['address1'] != "")?"":"hide";?> mb-3">
                        <div class="row form-row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="county" id="county" value="<?=$personal_details['county']?>" class="form-control" required data-afd-result="TraditionalCounty"></div>
                            <div class="col-md-5"></div> 
                        </div>
                	</div>
                    <div class="form-group extra_add <?=($personal_details['address1'] != "")?"":"hide";?> mb-5">
                        <div class="row form-row mb-3">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="postcode_box" id="postcode_box" value="<?=$personal_details['postcode_box']?>" class="form-control" required data-afd-result="Postcode"></div>
                            <div class="col-md-5"></div> 
                        </div>
                	</div>
                    <!-- <div class="form-row">
