                ...
                <div class="row form-row  mb-3 mt-3">
                 ...
                 <div class="monthly_payment_box <?=($payment_options['choose_payment_option_monthly'] == 1)?"":"hide";?>">
                    ...
                    <div class="row form-row mt-3 mb-3">
                        <div class="col-md-1">&nbsp;</div>
                        <div class="col-md-9"><p>The monthly contribution that you can pay into your Lifetime ISA is from &pound;<?=LISA_MONTHLY_MIN_AMOUNT?> up to &pound;<?=LISA_MONTHLY_MAX_AMOUNT?> in the current tax year.</p>
                        <?php if(get_session('set_topup') == true){?>
                ...
                <?php if(get_session('valid_dob') == true){?><input type="checkbox" id="<?php if(get_session('valid_dob') == false){ echo 'lumpsum_payment';}?>" class="badgebox lisa_pay_option lisa_lumpsum_payment"  name="choose_payment_option_lumpsum" value="1" <?=($payment_options['choose_payment_option_lumpsum'] == 1 || get_session('valid_dob') == true)?"checked":"";?>><?php }?>
                    <div class="row form-group">
                       ...
                       <?php if(get_session('valid_dob') == true){?>
                        ...
                        <?php if(get_session('set_topup') == true){?>
                        <div class="col-md-1"></div>
                        <div class="col-md-11"><p>You can top-up your LISA from &pound;<?=@number_format($lumpsum_pay_amount_min,'0','',',');?> to &pound;<?=@number_format($lumpsum_pay_amount_max,'0','',',');?> in the current tax year.  Don't forget to deduct any payments already made this tax year.<br>Your lump sum payment will be taken at the end of your application.</p></div>
                        <?php }else{?>
                        <div class="col-md-1"></div>
                        <div class="col-md-11"><p>The amount that you can pay into your Lifetime ISA is from &pound;<?=@number_format($lumpsum_pay_amount_min,'0','',',');?> up to &pound;<?=@number_format($lumpsum_pay_amount_max,'0','',',');?> in the current tax year.<br>Your lump sum payment will be taken at the end of your application.</p></div>
                        <?php }?>
                    </div>
                 </div>
                 ...
                 <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><label for="transfer_payment" class="btn-payment-option">Make a transfer in from another ISA provider <input type="checkbox" id="transfer_payment" class="badgebox lisa_pay_option lisa_transfer_payment" name="choose_payment_option_transfer" value="1" <?=($payment_options['choose_payment_option_transfer'] == 1)?'checked="checked"':'';?> ><span class="badge"><?=($payment_options['choose_payment_option_transfer'] == 1)?"&check;":"&check;";?></span></label>
                    </div>
                </div>
