            ...
            <hr>
                ...
                <div class="lumpsum_payment_box <?php if(get_session('valid_dob') == false){ echo 'hide';}?>">
                    <div class="row form-group">
                        ...
                        <?php }?>
                        <?php if(get_session('set_topup') == true){?>
                        <p>You can top-up your LISA from &pound;<?=@number_format($lumpsum_pay_amount_min,'0','',',');?> to &pound;<?=@number_format($lumpsum_pay_amount_max,'0','',',');?> in the current tax year.  Don't forget to deduct any payments already made this tax year.<br>Your lump sum payment will be taken at the end of your application.</p>
                        <?php }else{?>
                ...
                <div class="transfer_payment_box hide">
                	<div class="row form-row mt-2 mb-2">
                     	<div class="col-md-1"></div>
                        <div class="col-md-6">
                               <label for="ISA_transfer_option" class="pay-transfer-option"><input type="checkbox" id="ISA_transfer_option" name="ISA_transfer_option" value="1" class="badgebox ISA_transfer_option "><span class="badge">&check;</span>Tick this box if you want to transfer an existing ISA to a Foresters LISA.</label>
