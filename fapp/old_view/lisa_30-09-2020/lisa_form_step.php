...
?>
	<div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
            <div class="title-content d-none d-lg-block">
                <h3>Lifetime ISA <?php if(get_session('set_topup') == true){ echo "Top-up";}?></h3></div>
            </div>
        </div>
    </div>
    ...
    <div class="page">
            ...
            <hr>
                ...
                <div class="row form-row mb-3">
                 ...
                 <?php if(get_session('set_topup') == true){?>
                    <div class="form-group mb-5 mt-5">
                        ...
                        <hr>
                            <div class="row form-row  mb-3">
                                <div class="col-lg-3 text-right font-weight-bold"><label>Existing Lifetime ISA policy number</label></div>
                                <div class="col-lg-4">
                ...
                <div class="form-group">
                    ...
                    <hr>
                     <div class="row form-row mb-3 new_address">
                        ...
                        <div class="col-lg-4  afd-typeahead-container">
                ...
                data-afd-control="typeahead">
                    ...
                    <div class="form-group old_address hide mt-2">
                        ...
                        <div class="row form-row mt-2 mb-3">
                            <div class="col-lg-3"></div><div class="col-lg-6">Please type your address or postcode and select from the list.</div><div class="col-lg-3"></div>
                ...
                <div  class="form-group mt-5">
                    ...
                    <hr>
                     ...
                     <div class="row form-row  mb-3">
                    <div class="col-lg-4 text-right font-weight-bold"><label>How did you hear about us?</label></div>
                    <div class="col-lg-4">
        ...
        <?php //$this->view('lisa/view_payment_options'); ?>
        </section>
...
<p>Once your payment is confirmed, your LISA application will be submitted to Foresters Friendly Society.</p>
        ...
        <section id="confirmation_section" class="your_details hide">
         <div class="row progressbar">
            ...
            <hr>
                 <h4>Your Lifetime ISA application has been submitted.</h4>
                
               <div class="row form-row">
               			<div class="col-lg-12 monthly_conf_text hide"><label>Your monthly contribution by Direct Debit has now been set up. The first payment will be collected on or around 1st <?=date("F Y", strtotime("+38 days"))?>.</label></div>
...
This reference number will be emailed to you but you can also print this page. Please quote this reference number whenever you talk to us about your Lifetime ISA.<br><br>

<strong>What happens next?</strong><br>

You will receive your Lifetime ISA pack in the post within 5 working days. Please keep it in a safe place.<br><br>
...
Thank you for choosing us as the provider of your Lifetime ISA.<br>
...
<a href="https://www.forestersfriendlysociety.co.uk/foresters-customers/foresters-extras/" target="_blank">Now you're a member, don't forget about your free member benefits</a></p></div>
        ...
        <div class="row">
        	<div class="col-lg-12">
            	<a href="<?=base_url('lisa/close_application')?>" class="btn pull-right closebtn">Close this window</a>
            </div>
        </div>
        </section>
