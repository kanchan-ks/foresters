...
<form name="frmupdate_paymentoption" id="frmupdate_paymentoption" action="" method="post">
        <input type="hidden" name="data_type" value="payment_options">
            ...
            <hr>
                <div class="row form-row  mb-3">
                    <div class="col-md-12 font-weight-bold"><label for="lumpsum_payment" class="btn-payment-option">Make a lump sum payment by debit card <input type="checkbox" id="lumpsum_payment" class="badgebox lisa_pay_option" name="choose_payment_option_lumpsum" value="1" <?=($payment_options['choose_payment_option_lumpsum'] == 1)?"checked":"";?>><span class="badge">&plus;</span></label>
                    </div>
                </div>
                <div class="lumpsum_payment_box <?=($payment_options['choose_payment_option_lumpsum'] == 1)?"":"hide";?>">
                    <div class="row form-group">
                        ...
                        <div class="col-md-1"></div>
                        <div class="col-md-11 mt-5"><p>The amount that you can pay into your Lifetime ISA is from &pound;500 up to &pound;4,000 in the current tax year.<br>Your lump sum payment will be taken at the end of your application.</p></div>
                    </div>
                 </div>
                ...
                <div class="transfer_payment_box <?=($payment_options['choose_payment_option_transfer'] == 1)?"":"hide";?>">
                    ...
                    <div class="row form-row mt-3 mb-2 ">
                     ...
                     <div class="row form-row mt-2 mb-2">
                        ...
                        <div class="col-md-2 mb-2">
                               <label for="type_of_ISA_lisa" class="pay-transfer-option"><input type="radio" id="type_of_ISA_lisa" name="type_of_ISA" value="Lifetime ISA" class="badgebox type_of_ISA" <?=($payment_options['type_of_ISA'] == "Lifetime ISA")?"checked":"";?>><span class="badge">&check;</span>Lifetime ISA</label>
                             
                        </div>
                    </div>
                    <div class="row form-row mt-3 mb-2 <?=($payment_options['type_of_ISA'] == "Lifetime ISA")?"":"hide";?> hmrc_lisa_registration_number_box">
                        	<div class="col-md-1">&nbsp;</div>
                            <div class="col-md-5"><input placeholder="HMRC Lifetime ISA Registration Number (if known)" type="text" name="hmrc_lisa_registration_number"  class="form-control  mb-3" value="<?=$payment_options['hmrc_lisa_registration_number']?>"></div>
                            <div class="col-md-6"></div> 
                    </div>
