	...
	<div class="container-fluid">
        <div class="row">
            <div class="title-content d-none d-md-block">
                <h3>Lifetime ISA <?php if(get_session('set_topup') == true){ echo "Top-up";}?></h3>
            </div>
        </div>
    </div>
                ...
                <div class="row form-row mb-3">
                 ...
                 <?php if(get_session('set_topup') == true){?>
                    <div class="form-group mb-5 mt-5">
                        ...
                        <hr>
                            <div class="row form-row  mb-3">
                                <div class="col-md-3 text-right font-weight-bold"><label>Existing Lifetime ISA policy number</label></div>
                                <div class="col-md-4">
