...
if($personal_details['address1'] !="")
	$previous_address .= '<div class="col-md-3 mb-3 text-right font-weight-bold"><label>Address line 1:</label></div><div class="col-md-4"><input type="text" disabled="disabled" class="form-control mt-2" value="'.$personal_details['address1'].'"></div><div class="col-md-5  mb-3"></div>';

if($personal_details['address2'] !="")
	$previous_address .= '<div class="col-md-3 mb-3 text-right font-weight-bold"><label>Address line 2:</label></div><div class="col-md-4"><input type="text" class="form-control mt-2" disabled="disabled" value="'.$personal_details['address2'].'"></div><div class="col-md-5 mb-3"></div>';
	
if($personal_details['town'] !="")
	$previous_address .= '<div class="col-md-3 mb-3 text-right font-weight-bold"><label>Town:</label></div><div class="col-md-4"><input type="text" class="form-control mt-2" disabled="disabled" value="'.$personal_details['town'].'"></div><div class="col-md-5  mb-4"></div>';

if($personal_details['county'] !="")
	$previous_address .= '<div class="col-md-3 mb-3 text-right font-weight-bold"><label>County:</label></div><div class="col-md-4"><input type="text" class="form-control mt-2" disabled="disabled" value="'.$personal_details['county'].'"></div><div class="col-md-5  mb-3"></div>';
	
if($personal_details['postcode_box'] !="")
	$previous_address .= '<div class="col-md-3 mb-3 text-right font-weight-bold"><label>Postcode:</label></div><div class="col-md-4"><input type="text" class="form-control mt-2" disabled="disabled" value="'.$personal_details['postcode_box'].'"></div><div class="col-md-5  mb-3"></div>';	
