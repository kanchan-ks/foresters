...
<div class="row bg-light">      
                                ...
                                <div class="col-md-3 <?php if(get_session('valid_child_dob') == false){ echo "hide";}?>"><label>National Insurance number</label></div>
                                <div class="col-md-9 font-weight-bold <?php if(get_session('valid_child_dob') == false){ echo "hide";}?>"><label><?=strtoupper($personal_details['NI1'] .' '. $personal_details['NI2'].' '. $personal_details['NI3'].' '.$personal_details['NI4'].' '.$personal_details['NI5'])?></label></div>
                                ...
                                <div class="col-md-3"><label>Existing JISA Policy Number</label></div>
                                ...
                                <?=$old_address?>
                                <div class="col-md-3"><label>I heard about you by</label></div>
                                <div class="col-md-9 font-weight-bold"><label><?=$personal_details['HeardAboutUs']?><?=($personal_details['HeardAboutUs_extra'] != "")?"<br>" . $personal_details['HeardAboutUs_extra']:"";?></label></div>
