                ...
                <div class="form-group">
                    ...
                    <hr>
                     <div class="row form-row mb-3 new_address">
                        ...
                        <div class="col-lg-2  afd-typeahead-container">
                            <input type="text" name="postcode" id="postcode" value="" class="form-control postcode" placeholder="Eg SO15 3EW" autocomplete="off" data-afd-control="lookupField">
                            </div>
                        <div class="col-lg-2  text-right  no-padding">
                            <button type="button" class="btn btn-success btn-sm find_address" data-afd-control="lookupButton">Find address</button>
                        </div>
                    ...
                    <div class="row form-row mb-3">
                    	<div class="col-lg-4"></div><div class="col-lg-4">Please enter your postcode and click "Find Address".</div><div class="col-lg-4"></div>
                    ...
                    <div class="form-group old_address hide mt-2">
                        ...
                        <div class="row form-row mt-2 mb-3">
                            <div class="col-lg-4"></div><div class="col-lg-6">Please type your address or postcode and select from the list.</div><div class="col-lg-2"></div>
                     ...
                     <h4>Please check your details. If you need to make changes, click 'Edit'. When you have finished, click 'Submit Application' to complete your application.</h4>
                        ...
                        <div class="mt-5 summarybox summary_child_box">
                           <h4 class="summary_heading pull-left">Child details</h4>
                            	<a href="javascript:;" class="summary_edit btn btn-sm btn-warning edit_child" data-type="child_details" data-step="1"><i class="fa fa-pencil"></i> Edit</a>
                        </div>
						
                       <span class="edit_child_section"></span>
                        <div class="col-md-12 summary_child_details"></div>  
...
<p>Once your payment is confirmed, your JISA application will be submitted to Foresters Friendly Society.</p>
        ...
        <section id="confirmation_section" class="your_details hide">
         <div class="row progressbar">
            ...
            <hr>
                 <h4>Your Junior ISA application has been submitted.</h4>
