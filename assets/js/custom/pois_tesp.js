...
/*$('body').on("click", '.pois_tesp_pay_option', function(){
	if($("input.pois_tesp_pay_option:checked").length > 0)
...
$("#pois_tesp_index").on("click", ".backbtn", function(){
	var steps = $(this).attr("data-step");
	var curObj = $(this);
	$.ajax({
		url : base_url + '/pois_tesp/back_step/',
		type: 'POST',
		dataType: 'json',
		data: {step: steps},
...
$("body #frmyourdetails").on("change", ".dob_day, .dob_month, .dob_year", function(){
	...
	{
		$.ajax({
			url : base_url + 'pois_tesp/check_dob/',
			type: 'POST',
			dataType: 'json',
...
$("body").on('click', '#next2', function () {
	...
	$("#frmyourdetails").validate({
		...
		submitHandler: function (form) {
			...
			$.ajax({
				url: base_url + 'pois_tesp/pois_tesp_form_submit/' + d_step,
				type: 'POST',
				dataType: 'json',
				data: $(form).serialize(),
				success: function (response) {
...
$("#pois_tesp_index").on("click", ".summary_edit", function(){
	var steps = $(this).attr("data-step");
	var type = $(this).attr("data-type");
	$.ajax({
		url : base_url + 'pois_tesp/edit_summary/',
		type: 'POST',
		dataType: 'json',
		data: {step: steps},
		success: function (response) {
...
$("#pois_tesp_index").on("click", "#next5", function(){
	...
	$("#frmsummary").validate({
		...
		submitHandler: function (form) {
			...
			$.ajax({
				url : base_url + 'pois_tesp/submit_application/',
				type: 'POST',
				dataType: 'json',
				data: {step: 5},
				success: function (response) {
...
{
	location.href = base_url + "pois_tesp/submit_worldPay";
}
